...
class UI{
    ...
    mostrarGastos(gastos){
        ...
        gastos.forEach( gasto =>{
            ...
            nuevoGasto.dataset.id = id; //Agrega el data-id
...
function preguntarPresupuesto() {
    ...
    //isNaN te dice si no es un numero
...
function agregarGasto(e) {
    ...
    switch (true) {
        case !nombre || !cantidad:
            ...
            return;
        case cantidad <= 0 || isNaN(cantidad):
    ...
    //Imprimir gastos
    const {gastos, restante} = presupuesto;       //Destructuring para solo pasarle los gastos
